        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Ubah Aset KIB E</h4>
            </div>
            <form method="POST" action="<?= site_url('asset/editKibe'); ?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Informasi Aset KIB E</h4>
            </div>
              <div class="modal-body">
                <table class="form-group">
                  <tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Tambah Aset KIB E</h4>
            </div>
            <form method="POST" action="<?= site_url('asset/tambahKibe'); ?>">
              <div class="modal-body">
                <table class="form-group">
                  <tr>
                    <td>ID Barang</td>
